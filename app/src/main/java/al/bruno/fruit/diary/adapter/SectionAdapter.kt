...
class SectionAdapter<S : Section<S, C>,
        C,
        SVH : ViewDataBinding,
        CVH : ViewDataBinding>(
    private val s: Int,
    ...
    override fun onCreateSectionViewHolder(
        ...
        return CustomViewHolder(
            LayoutInflater.from(sectionViewGroup?.context).inflate(s, sectionViewGroup, false),
            bindingData
        )
    }
    ...
    override fun onCreateChildViewHolder(
        ...
        return ChildViewHolder(
            LayoutInflater.from(childViewGroup?.context).inflate(c, childViewGroup, false),
            childData
        )
    }

    override fun onBindSectionViewHolder(
        sectionViewHolder: CustomViewHolder<S, SVH>,
        sectionPosition: Int,
        section: S?
    ) {
    ...
    override fun onBindChildViewHolder(
        childViewHolder: ChildViewHolder<S, C, CVH>,
        section: S?,
        childPosition: Int,
        child: C?
    ) {
